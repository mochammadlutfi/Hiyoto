...
@section('content')
<!-- Hero -->
<div class="bg-image mt-lg-4" style="background-image: url({{ asset('img/hero/branch.jpg') }});background-position: revert;">
    <div class="bg-black-op-75">
        <div class="content text-center">
            <div class="py-lg-6">
                <h1 class="font-w700 mb-10 text-white">{{ __('front_menu.branch.title') }}</h1>
            </div>
        </div>
    </div>
</div>
...
<script src="{{ asset('js/umum/branch.js') }}"></script>
@endpush