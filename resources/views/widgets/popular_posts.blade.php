<div class="widget-category list-category-1-item py-lg-4">
    ...
    <a class="block bg-image d-flex flex-column text-center" href="{{ route('post.detail', $p->translate()->slug) }}" style="background-image: url('{{ asset($p->featured_img) }}');" href="javascript:void(0)">
