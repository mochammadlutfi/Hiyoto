                ...
                <div class="block-content  tab-content px-1 py-2">
                    <div class="tab-pane active" id="indonesia-link" role="tabpanel">
                        <div class="form-group">
                            ...
                            <div class="col-12">
                                <input type="text" class="form-control" id="field-title" name="title" value="{{ $data->translate('id')->title }}">
                    ...
                    <div class="tab-pane" id="english-link" role="tabpanel">
                        <div class="form-group">
                            ...
                            <div class="col-12">
                                <input type="text" class="form-control" id="field-en_title" name="en_title" value="{{ $data->translate('en')->title }}">
        ...
        <div class="col-lg-4">
            <div class="block block-shadow block-rounded block-bordered">
                <div class="block-content">
                    ...
                    <div class="form-group row">
                        <div class="col-lg-12">
                            <select class="form-control" name="kategori" id="field-kategori" data-id="{{ $data->category_id }}" data-text="{{ $data->category->translate()->title }}"></select>
                    ...
                    <div class="row gutters-tiny items-push">
                        ...
                        <div class="col-lg-12">
                            <div class="text-center mb-15">
                                <img id="img_preview" src="{{ asset($data->featured_img) }}" class="img-fluid">
                            </div>
