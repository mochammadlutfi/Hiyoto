    ...
    <div class="row invisible" data-toggle="appear">
        ...
        <div class="col-6 col-md-3 col-xl-3">
            <a class="block text-center block-shadow block-bordered" href="#">
                <div class="block-content ribbon ribbon-left ribbon-bookmark ribbon-primary">
                    <div class="ribbon-box">{{ $data['product'] }}</div>
                    <p class="mt-5">
                        <i class="si si-basket-loaded fa-3x"></i>
                    </p>
                    <p class="font-w600">Total Produk</p>
                </div>
            </a>
        </div>
        ...
        <div class="col-6 col-md-3 col-xl-3">
            <a class="block text-center block-shadow block-bordered" href="#">
                <div class="block-content ribbon ribbon-left ribbon-bookmark ribbon-primary">
                    ...
                    <p class="font-w600">Tambah Produk</p>
                </div>
            </a>
        </div>
    </div>
            ...
            <div class="block">
                <div class="block-header">
                    <h3 class="block-title">
                        Statistik Pengunjung <small>Bulan Ini</small>
                    </h3>
                </div>
                    ...
                    <div class="row">
                        ...
                        <div class="col-lg-4 col-md-6 col-sm-12 col-12">
                            ...
                            <div class="mb-0 mt-3 legend-item">
                                ...
                                <span class="legend-text">Total Kunjungan </span>
                            </div>
                        </div>
                        <div class="col-lg-4 col-md-6 col-sm-12 col-12">
                            <h2 class="font-weight-normal mb-3 font-size-h4">
