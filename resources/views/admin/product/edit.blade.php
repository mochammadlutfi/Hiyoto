            ...
            <div class="block block-shadow block-rounded block-bordered">
                ...
                <div class="block-content  tab-content px-1 py-2">
                    <div class="form-group">
                        ...
                        <div class="col-12">
                            <input type="text" class="form-control" id="field-name" name="name" value="{{ $data->title }}">
                    ...
                    <div class="tab-pane active" id="indonesia-link" role="tabpanel">
                        <div class="form-group">
                            ...
                            <div class="col-12">
                                <textarea class="form-control post-desc" id="field-description" name="description" rows="8"><?= $data->translate('id')->description; ?></textarea>
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-12">
                                <textarea class="form-control post-desc" id="field-application" name="application" rows="8">{!! $data->translate('id')->application !!}</textarea>
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-12">
                                <textarea class="form-control post-desc" id="field-technical" name="technical" rows="8">{!! $data->translate('id')->technical !!}</textarea>
                    ...
                    <div class="tab-pane" id="english-link" role="tabpanel">
                        <div class="form-group">
                            ...
                            <div class="col-12">
                                <textarea class="form-control post-desc" id="field-en_description" name="en_description" rows="8">{!! $data->translate('en')->description !!}</textarea>
        ...
        <div class="col-lg-4">
            <div class="block block-shadow block-rounded block-bordered">
                <div class="block-content">
                    ...
                    <div class="form-group row">
                        <div class="col-lg-12">
                            <div class="form-control c-pointer" data-toggle="modal" data-target="#categorySelectModal" id="field-kategori">
                                {{ $data->kategori_select }}
                            </div>
                    ...
                    <div class="row gutters-tiny items-push">
                        ...
                        <div class="col-lg-12">
                            <div class="text-center mb-15">
                                <img id="img_preview" src="{{ asset($data->image_url) }}" width="100%">
                            </div>
