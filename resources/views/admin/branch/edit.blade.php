...
@section('content')
<div class="content">
    <form id="form-branch" onsubmit="return false;" enctype="multipart/form-data">
    @csrf
            ...
            <div class="row">
                    ...
                    <div class="row">
                        <div class="col-lg-8">
                            <div class="form-group">
                                ...
                                <select class="form-control find-daerah" id="field-daerah" name="daerah" data-id="{{ $data->city_id }}" data-text="{{ ucwords(strtolower($data->city->name)).', '. ucwords(strtolower($data->city->provinsi->name)) }}"></select>
                        ...
                        <div class="col-lg-4">
                            <div class="form-group">
                                ...
                                <input type="text" class="form-control" id="field-postal_code" name="postal_code" value="{{ $data->postal_code }}">
                ...
                <div class="col-lg-6">
                    <div class="form-group">
                        ...
                        <textarea class="form-control" id="field-address" name="address" rows="5">{{ $data->address }}</textarea>
...
<script src="{{ asset('js/admin/branch/form.js') }}"></script>
@endpush
