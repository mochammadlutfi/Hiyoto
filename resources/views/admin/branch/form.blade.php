            ...
            <div class="row">
                ...
                <div class="col-lg-6">
                    <div class="row">
                        <div class="col-lg-8">
                            <div class="form-group">
                                <label for="field-phone">No. Telepon</label>
                                <input type="text" class="form-control" id="field-phone" name="phone">
                    ...
                    <div class="form-group">
                        ...
                        <textarea class="form-control" id="field-address" name="address" rows="1"></textarea>
